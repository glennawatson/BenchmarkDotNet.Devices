...
namespace BenchmarkDotNet.Toolchains.MsBuildSdkExtras
{
    ...
    /// that will allow additional TargetFramework's to be targetted.
    /// </summary>
    public class MsBuildSdkExtrasGenerator : DotNetCliGenerator
    {
        public string RuntimeFrameworkVersion { get; }

        protected virtual string TemplateName => "MsBuildSdkExtrasCsProj.txt";
