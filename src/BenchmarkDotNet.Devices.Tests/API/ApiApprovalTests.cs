...
namespace BenchmarkDotNet.Devices.Tests
{
    /// <summary>
    ...
    public class ApiApprovalTests
    {
        ...
        /// <summary>
        /// Tests to make sure the DotNetBenchmark.MsBuild.Sdk.Extras project is approved.
        /// </summary>
        [Fact]
        public void MsBuildSdkExtrasProject()
        {
            CheckApproval(typeof(MsBuildSdkExtrasGenerator).Assembly);
        }
